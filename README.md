...
3. mprove the internal business processes of this organization, at least with respect to the time it takes to manage vacation time requests
## Constraints
1. Web Application
...
4. he architecture must account for the fact that the client and server are only connected long enough to process a single request, requiring a robust client state management mechanism (such as cookies or URL redirection
